...
router.post('/add', function (req, res) {
    ...
    db.query("insert into person(name,age,professional) values('" + name
        + "'," + age + ",'" + professional + "')", function (err, rows) {
        if (err) {
            res.end('新增失败：' + err);
        } else {
...
router.post('/update', function (req, res) {
    ...
    var age = req.body.age;
    var professional = req.body.professional;
    db.query("update person set name='" + name
        + "',age='" + age + "',professional= '" + professional
